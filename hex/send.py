            ...
            if (ACK_state_flag):
                ...
                ACK_state_flag=0 
                    ...
                    if (RJT_state_flag): 
                        ...
                        print(packet_sequence,"RJT İ")
                        rjt_count= rjt_count+1 #3 kere rjt gelirse diye bir olay var
                        if(rety_id==0):
                            send_firmware(device_id,hex_packet_size,hex_packet,packet_no,constants.SEND_COMMAND_51) ##device id -1    
                            print("command 51")
                        elif(ACK_state_flag):
                            break
            read_ack()
